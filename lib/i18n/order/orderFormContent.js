export const orderFormContent = {
    de: {
        ...
        subtitle:
            "Bitte beantworte die folgenden Fragen möglichst vollständig und lade mindestens ein Referenzbild\u00A0hoch. " +
        ...
        references: {
            ...
            notice: "Je klarer das gewünschte Motiv zu erkennen ist, desto besser. " +
                "Referenzbilder mit einem klaren Fokus auf das gewünschte Motiv erleichtern die Umsetzung deiner Vorstellungen.",
    ...
    en: {
        ...
        subtitle:
            "Please answer the following questions as thoroughly as possible and upload at least one reference image. " +
        ...
        references: {
            ...
            notice: "The clearer the desired subject is, the better. " +
                "Reference images that clearly focus on the subject help bring your vision to life.",
